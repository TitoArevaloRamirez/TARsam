...
int main(int argc, char **argv)
{
    ...
    pubCornerPointsLessSharp = nh.advertise<sensor_msgs::PointCloud2>("tar_sam/feature/cloudLessSharp", 100);

    pubSurfPointsFlat = nh.advertise<sensor_msgs::PointCloud2>("tar_sam/feature/cloudFlat", 100);

    pubSurfPointsLessFlat = nh.advertise<sensor_msgs::PointCloud2>("tar_sam/feature/cloudLessFlat", 100);
